/* =========================================================
   ...
   Used on: menu2.html (full) and index2.html (header search box)
   ========================================================= */
...
/* ---------------------------------------------------------
   ...
   Enter / click search icon -> go to menu2.html?q=keyword
--------------------------------------------------------- */
function initHeaderSearch(){
  ...
  function goSearch(){
    ...
    const onMenuPage = window.location.pathname.endsWith("menu2.html");

    if(onMenuPage){
      filterCards(keyword);
    }else{
      window.location.href = "menu2.html?q=" + encodeURIComponent(keyword);
    }
  }
