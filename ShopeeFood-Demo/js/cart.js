/* =========================================================
   CART.JS — Cart page logic (cart.html only)
...
function renderCart(){
  ...
  cart.forEach((item, index)=>{
    ...
    const imgSrc = item.image || "img/f6.webp";
...
/* ---------------------------------------------------------
   AUTO-APPLY A VOUCHER HANDED OFF FROM voucher.html
--------------------------------------------------------- */
...
function updateSummary(){
  ...
  // Persist the computed order for checkout.html to read
