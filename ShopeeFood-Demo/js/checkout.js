/* =========================================================
   CHECKOUT.JS — Checkout page logic (checkout.html only)
   ========================================================= */
  ...
  if(summary.items.length === 0){
    document.getElementById("checkout-form").innerHTML =
      `<div class="empty-state" style="padding:30px 0;">
         ...
         <a href="menu.html" class="btn btn-primary" style="margin-top:16px;">Chọn món ngay</a>
       </div>`;
...
/* ---------------------------------------------------------
   SAVE ORDER TO HISTORY (localStorage, read by orders.html)
--------------------------------------------------------- */
